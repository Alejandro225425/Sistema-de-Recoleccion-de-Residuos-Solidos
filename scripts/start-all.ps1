...
function Start-ServiceProcess {
  ...
  Start-Process powershell -ArgumentList @(
    ...
    "-NoExit",
    "-Command",
    "Set-Location `"$WorkingDirectory`"; `$env:DATABASE_URL=`"$databaseUrl`"; $Command; Write-Host ''; Write-Host 'Cierra esta ventana para detener el servicio' -ForegroundColor Yellow"
