...
- Se corrigió `vercel.json` para evitar la ruta duplicada `frontend/frontend/package.json` que causaba fallo en `npm --prefix frontend install` dentro de Vercel.
