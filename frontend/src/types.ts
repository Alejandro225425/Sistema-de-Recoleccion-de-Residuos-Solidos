...
export type Truck = { id: number; code: string; driver: string; status: string; zone: string; zone_id?: number; user_id?: number | null; latitude: number; longitude: number };
